...
CONFIG = {
    # --- Data source ---
    "data_source": "../TS-Driver/Asym_Kernel_Tests/Asym_JW/pltFile",
    "plot_prefix": "pltQuiescentWang",
    "output_dir": "../TS-Driver/Asym_Kernel_Tests/Asym_JW/Plots",
...
def _process_stability_diagnostics(config, probe_data=None):
    ...
    try:
        ...
        if len(gpi_results) > 0:
            gpi_out = output_dir / f"gpi_profiles_{var_slug}.png"
