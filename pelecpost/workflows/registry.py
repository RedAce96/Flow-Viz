...
RECIPES: dict[str, RecipeDefinition] = {
    ...
    for item in (
        ...
        _recipe(
            ...
            outputs=(
                "transient.stft", "transient.envelope", "transient.group_velocity",
                "transient.filtered_overlay.figure", "transient.envelope_overlay.figure",
                "transient.stft_figure", "probe.raw_history.figure",
                "probe.method_ready.figure",
            ),
        ...
        _recipe(
            ...
            outputs=(
                "nonlinear.bicoherence", "nonlinear.triads",
                "nonlinear.bicoherence.figure",
                "probe.raw_history.figure", "probe.method_ready.figure",
            ),
        ...
        _recipe(
            ...
            outputs=(
                "modal.pod", "modal.spod", "modal.dmd", "modal.sensitivity",
                "modal.pod.figure", "modal.spod.figure", "modal.dmd.figure",
                "probe.raw_history.figure", "probe.method_ready.figure",
            ),
